...
// Applique AUTOMATIQUEMENT une lecture photo en mode « ajout » (aucune validation à
// cliquer), puis poste un récap avec un FILET de secours : 📸 basculer en « coffre =
// exact » ou ↩️ annuler l'ajout. Mode « add » = jamais destructeur (rien n'est retiré).
async function _appliquerAuto(channel, items, by, db, inv, client) {
  try {
    inv.lectures = inv.lectures || {};
