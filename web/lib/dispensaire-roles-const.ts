...
export const CONFIG_DEFAUT: Config = { seuilRenvoi: 3, prixBandage: 4, plafondBandage: 10, delaiFactureJours: 7, pointageInactiviteMin: 480, pointageEscaladeH: 24 };
export const CONFIG_CHAMPS: { cle: keyof Config; label: string; aide: string }[] = [
  ...
  { cle: "pointageInactiviteMin", label: "Inactivité avant « à confirmer » (min)", aide: "Sans signal du navigateur pendant cette durée, un service ouvert passe « à confirmer » (jamais clôturé de force). Défaut 480 min (8 h) : adapté à un suivi manuel de présence. Baisse-le si tu veux une détection plus stricte des oublis." },
