...
import { getMouvementsStock } from "@/app/(app)/armurerie/actions";
...
export default async function ArmureriePage() {
  const [{ connecte, clients, ventes, contrats, ca, coffre, mouvementsCoffre, produits, employes, pointages, paies, impots, notes, taches, commandes, ressources, rdvs }, mouvementsStock] = await Promise.all([
    getArmurerie(),
    getMouvementsStock(),
  ]);
