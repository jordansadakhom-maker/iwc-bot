          ...
          <div className="relative">
            ...
            {bellOpen ? (
              <>
                ...
                <div className="iwc-pop absolute right-0 z-40 mt-2 w-[330px] overflow-hidden rounded-2xl border border-border-2 bg-[color-mix(in_srgb,var(--surface)_85%,transparent)] shadow-2xl backdrop-blur-xl">
