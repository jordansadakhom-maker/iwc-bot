...
const LABEL: Record<string, string> = {
  ...
  "pointage.reprise": "Service repris", "pointage.oubli": "Clôturé après oubli", "pointage.correction": "Fin corrigée (salarié)", "pointage.validation": "Validé par la Direction", "pointage.heures_ajust": "Heures d'effectif ajustées",
  ...
  "rendez_vous.cree": "Rendez-vous planifié", "rendez_vous.etat": "Rendez-vous — statut changé", "rendez_vous.supprime": "Rendez-vous supprimé",
  "intervention.creee": "Intervention planifiée", "intervention.demarree": "Intervention démarrée", "intervention.terminee": "Intervention terminée", "intervention.annulee": "Intervention annulée", "intervention.cro": "Compte-rendu modifié", "intervention.supprimee": "Intervention supprimée",
  "chambre.creee": "Chambre ajoutée", "chambre.occupee": "Chambre occupée", "chambre.liberee": "Chambre libérée", "chambre.etat": "Chambre — état changé", "chambre.supprimee": "Chambre supprimée",
  "ambulance.creee": "Ambulance ajoutée", "ambulance.etat": "Ambulance — état changé", "ambulance.maj": "Ambulance modifiée", "ambulance.supprimee": "Ambulance supprimée",
  "salaire.bareme": "Barème modifié", "salaire.prime": "Prime ajustée", "salaire.jours": "Jours ajustés",
  "paie.archive": "Semaine de paie figée", "paie.supprime": "Archive de paie supprimée",
};
const MODULE_LABEL: Record<string, string> = { membre: "Accès", grade: "Grades", config: "Config", salarie: "RH", sanction: "Sanctions", stock: "Stock", coffre: "Coffres", matiere: "Matières", vente: "Ventes", facture: "Factures", fdo: "FDO", frais: "Frais", certificat: "Certificats", rapport: "Rapports", pointage: "Pointage", patient: "Patients", prise_en_charge: "Prise en charge", fabrication: "Fabrication", rendez_vous: "Rendez-vous", intervention: "Interventions", chambre: "Chambres", ambulance: "Ambulances", salaire: "Salaires", paie: "Paie" };
const TON: Record<string, string> = { membre: "var(--accent)", grade: "var(--warn)", config: "var(--steel)", salarie: "var(--good)", sanction: "var(--oxblood)", stock: "var(--accent)", coffre: "var(--steel)", matiere: "var(--warn)", vente: "var(--good)", facture: "var(--accent)", fdo: "var(--steel)", frais: "var(--warn)", certificat: "var(--good)", rapport: "var(--steel)", pointage: "var(--accent)", patient: "var(--good)", prise_en_charge: "var(--accent)", fabrication: "var(--warn)", rendez_vous: "var(--accent)", intervention: "var(--oxblood)", chambre: "var(--good)", ambulance: "var(--steel)", salaire: "var(--brass-hi)", paie: "var(--accent)" };
